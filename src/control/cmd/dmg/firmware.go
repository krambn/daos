...
type firmwareOption struct {
	Firmware firmwareCmd `command:"firmware" alias:"fw" description:"Manage the storage device firmware"`
}
...
func (c *firmwareQueryCmd) Execute(args []string) error {
	return nil
}
...
func (c *firmwareUpdateCmd) Execute(args []string) error {
	return nil
}
